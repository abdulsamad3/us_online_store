...
public class ItemAddressNewBindingImpl extends ItemAddressNewBinding implements com.iqonic.usonlinestore.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sIncludes.setIncludes(3, 
            ...
            new int[] {4},
            new int[] {com.iqonic.usonlinestore.R.layout.item_address});
    ...
    private ItemAddressNewBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (com.iqonic.usonlinestore.databinding.ItemAddressBinding) bindings[4]
            , (android.widget.RadioButton) bindings[7]
            , (com.iqonic.usonlinestore.utils.swipereveallayout.SwipeRevealLayout) bindings[0]
            );
        ...
        setRootTag(root);
        // listeners
        mCallback3 = new com.iqonic.usonlinestore.generated.callback.OnClickListener(this, 3);
        mCallback1 = new com.iqonic.usonlinestore.generated.callback.OnClickListener(this, 1);
        mCallback2 = new com.iqonic.usonlinestore.generated.callback.OnClickListener(this, 2);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.model == variableId) {
            setModel((com.iqonic.usonlinestore.models.Address) variable);
        }
    ...
    public void setModel(@Nullable com.iqonic.usonlinestore.models.Address Model) {
        this.mModel = Model;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeIncluded((com.iqonic.usonlinestore.databinding.ItemAddressBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeIncluded(com.iqonic.usonlinestore.databinding.ItemAddressBinding Included, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        com.iqonic.usonlinestore.models.Address model = mModel;
