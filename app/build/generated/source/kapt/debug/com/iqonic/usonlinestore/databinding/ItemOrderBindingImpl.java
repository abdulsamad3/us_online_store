...
public class ItemOrderBindingImpl extends ItemOrderBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvSeller, 4);
        sViewsWithIds.put(R.id.tvTotalItem, 5);
        sViewsWithIds.put(R.id.tvPrice, 6);
        sViewsWithIds.put(R.id.tvOriginalPrice, 7);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.model == variableId) {
            setModel((com.iqonic.usonlinestore.models.MyOrderData.LineItem) variable);
        }
    ...
    public void setModel(@Nullable com.iqonic.usonlinestore.models.MyOrderData.LineItem Model) {
        this.mModel = Model;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.iqonic.usonlinestore.models.MyOrderData.LineItem model = mModel;
