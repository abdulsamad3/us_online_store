...
public class ItemColorBindingImpl extends ItemColorBinding implements com.iqonic.usonlinestore.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvColor, 2);
        sViewsWithIds.put(R.id.viewColor, 3);
        sViewsWithIds.put(R.id.ivColorChecked, 4);
    }
    // views
    @NonNull
    ...
    private ItemColorBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback20 = new com.iqonic.usonlinestore.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.model == variableId) {
            setModel((com.iqonic.usonlinestore.models.Color) variable);
        }
    ...
    public void setModel(@Nullable com.iqonic.usonlinestore.models.Color Model) {
        this.mModel = Model;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.iqonic.usonlinestore.models.Color model = mModel;
