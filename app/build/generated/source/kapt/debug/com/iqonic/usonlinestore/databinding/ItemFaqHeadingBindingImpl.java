...
public class ItemFaqHeadingBindingImpl extends ItemFaqHeadingBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.model == variableId) {
            setModel((com.iqonic.usonlinestore.models.Category) variable);
        }
    ...
    public void setModel(@Nullable com.iqonic.usonlinestore.models.Category Model) {
        this.mModel = Model;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.iqonic.usonlinestore.models.Category model = mModel;
