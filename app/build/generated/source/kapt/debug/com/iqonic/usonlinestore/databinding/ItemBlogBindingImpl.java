...
public class ItemBlogBindingImpl extends ItemBlogBinding implements com.iqonic.usonlinestore.generated.callback.OnClickListener.Listener {
    ...
    private ItemBlogBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback29 = new com.iqonic.usonlinestore.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.model == variableId) {
            setModel((com.iqonic.usonlinestore.models.Blog) variable);
        }
    ...
    public void setModel(@Nullable com.iqonic.usonlinestore.models.Blog Model) {
        this.mModel = Model;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.iqonic.usonlinestore.models.Blog model = mModel;
