...
public class ItemTrackBindingImpl extends ItemTrackBinding implements com.iqonic.usonlinestore.generated.callback.OnClickListener.Listener {
    ...
    private ItemTrackBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            , (com.iqonic.usonlinestore.utils.CircleView) bindings[3]
            , (com.iqonic.usonlinestore.utils.LineView) bindings[2]
        ...
        setRootTag(root);
        // listeners
        mCallback11 = new com.iqonic.usonlinestore.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.model == variableId) {
            setModel((com.iqonic.usonlinestore.models.OrderTrack) variable);
        }
    ...
    public void setModel(@Nullable com.iqonic.usonlinestore.models.OrderTrack Model) {
        this.mModel = Model;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.iqonic.usonlinestore.models.OrderTrack model = mModel;
