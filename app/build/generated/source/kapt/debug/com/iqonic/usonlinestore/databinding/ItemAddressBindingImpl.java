...
public class ItemAddressBindingImpl extends ItemAddressBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvUserName, 1);
        sViewsWithIds.put(R.id.tvEdit, 2);
        sViewsWithIds.put(R.id.tvDefault, 3);
        sViewsWithIds.put(R.id.tvAddress, 4);
        sViewsWithIds.put(R.id.tvMobileNo, 5);
    }
    // views
    @NonNull
