...
public class ItemSizeBindingImpl extends ItemSizeBinding implements com.iqonic.usonlinestore.generated.callback.OnClickListener.Listener {
    ...
    private ItemSizeBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.ivSizeChecked.setTag(null);
        this.llSize.setTag(null);
        setRootTag(root);
        // listeners
        mCallback9 = new com.iqonic.usonlinestore.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.model == variableId) {
            setModel((com.iqonic.usonlinestore.models.Size) variable);
        }
    ...
    public void setModel(@Nullable com.iqonic.usonlinestore.models.Size Model) {
        this.mModel = Model;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.iqonic.usonlinestore.models.Size model = mModel;
        com.iqonic.usonlinestore.base.BaseRecyclerAdapter.OnClickListener<?> callback = mCallback;
        // batch finished
        if ((dirtyFlags & 0x4L) != 0) {
            // api target 1

            this.ivSizeChecked.setOnClickListener(mCallback9);
        }
    }
