...
import com.iqonic.usonlinestore.fragments.DashboardListFragment
...
class SettingActivity : AppBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lan = USonlineStoreApp.language
        val languages = resources.getStringArray(R.array.language)
        switchNightMode.isChecked = USonlineStoreApp.appTheme == Constants.THEME.DARK
        ...
        switchNotification.setOnCheckedChangeListener { _, isChecked ->
            USonlineStoreApp.getAppInstance().enableNotification(isChecked)
        }
        switchNightMode.setOnCheckedChangeListener { _, isChecked ->
            USonlineStoreApp.changeAppTheme(isChecked)
    ...
    override fun onBackPressed() {
        ...
        if (lan != USonlineStoreApp.language) {
    ...
    private fun setNewLocale(language: String) {
        USonlineStoreApp.changeLanguage(language)
        Log.e("lan", language)
        if (lan != language) {
            recreate()
