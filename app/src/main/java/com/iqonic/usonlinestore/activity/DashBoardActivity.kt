...
import com.iqonic.usonlinestore.fragments.WishListFragment
import com.iqonic.usonlinestore.fragments.home.HomeFragment
import com.iqonic.usonlinestore.fragments.home.HomeFragment2
import com.iqonic.usonlinestore.models.CategoryData
    ...
    private fun setUpDrawerToggle() {
        val toggle = object : ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close) {
            override fun onDrawerSlide(drawerView: View, slideOffset: Float) {
                ...
                if (USonlineStoreApp.language == "ar") {
