...
import com.iqonic.usonlinestore.USonlineStoreApp
import com.iqonic.usonlinestore.USonlineStoreApp.Companion.getAppInstance
...
import com.iqonic.usonlinestore.activity.ProductDetailActivity
import com.iqonic.usonlinestore.models.*
import com.iqonic.usonlinestore.utils.Constants
import com.iqonic.usonlinestore.utils.Constants.AppBroadcasts.ADDRESS_UPDATE
import com.iqonic.usonlinestore.utils.Constants.AppBroadcasts.CART_COUNT_CHANGE
import com.iqonic.usonlinestore.utils.Constants.AppBroadcasts.ORDER_COUNT_CHANGE
import com.iqonic.usonlinestore.utils.Constants.AppBroadcasts.PROFILE_UPDATE
import com.iqonic.usonlinestore.utils.Constants.AppBroadcasts.WISHLIST_UPDATE
import com.iqonic.usonlinestore.utils.Constants.KeyIntent.DATA
import com.iqonic.usonlinestore.utils.Constants.PLAY_STORE_URL_PREFIX
import com.iqonic.usonlinestore.utils.Constants.SharedPref.CART_DATA
import com.iqonic.usonlinestore.utils.Constants.SharedPref.CATEGORY_DATA
import com.iqonic.usonlinestore.utils.Constants.SharedPref.DEFAULT_CURRENCY
import com.iqonic.usonlinestore.utils.Constants.SharedPref.IS_LOGGED_IN
import com.iqonic.usonlinestore.utils.Constants.SharedPref.IS_SOCIAL_LOGIN
import com.iqonic.usonlinestore.utils.Constants.SharedPref.KEY_ADDRESS
import com.iqonic.usonlinestore.utils.Constants.SharedPref.KEY_CART_COUNT
import com.iqonic.usonlinestore.utils.Constants.SharedPref.KEY_DASHBOARD
import com.iqonic.usonlinestore.utils.Constants.SharedPref.KEY_ORDERS
import com.iqonic.usonlinestore.utils.Constants.SharedPref.KEY_RECENTS
import com.iqonic.usonlinestore.utils.Constants.SharedPref.KEY_USER_ADDRESS
import com.iqonic.usonlinestore.utils.Constants.SharedPref.KEY_WISHLIST_COUNT
import com.iqonic.usonlinestore.utils.Constants.SharedPref.SLIDER_IMAGES_DATA
import com.iqonic.usonlinestore.utils.Constants.SharedPref.THEME_COLOR
import com.iqonic.usonlinestore.utils.Constants.SharedPref.USER_DISPLAY_NAME
import com.iqonic.usonlinestore.utils.Constants.SharedPref.USER_EMAIL
import com.iqonic.usonlinestore.utils.Constants.SharedPref.USER_FIRST_NAME
import com.iqonic.usonlinestore.utils.Constants.SharedPref.USER_ID
import com.iqonic.usonlinestore.utils.Constants.SharedPref.USER_LAST_NAME
import com.iqonic.usonlinestore.utils.Constants.SharedPref.USER_NICE_NAME
import com.iqonic.usonlinestore.utils.Constants.SharedPref.USER_PROFILE
import com.iqonic.usonlinestore.utils.Constants.SharedPref.USER_ROLE
import com.iqonic.usonlinestore.utils.Constants.SharedPref.USER_TOKEN
import com.iqonic.usonlinestore.utils.Constants.SharedPref.USER_USERNAME
import com.iqonic.usonlinestore.utils.Constants.SharedPref.WISHLIST_DATA
...
fun getSharedPrefInstance(): SharedPrefUtils {
    return if (USonlineStoreApp.sharedPrefUtils == null) {
        USonlineStoreApp.sharedPrefUtils = SharedPrefUtils()
        USonlineStoreApp.sharedPrefUtils!!
    } else {
        USonlineStoreApp.sharedPrefUtils!!
    }
}
